...
public class VehicleRunner {
	...
	public static void main(String[] args) {
		...
		try {
			...
			list.add(new VehicleEntity(1,"Tesla Model S", "Tesla", 1234567890L, 22.5f, 100.0, true, 'E',customDate1, 5));
			list.add(new VehicleEntity(2,"Honda Accord", "Honda", 1234567891L, 20.0f, 2500.0, false, 'P', customDate2, 5));
			...
			list.add(new VehicleEntity(5,"Mercedes-Benz GLC","Mercedes-Benz", 1234567894L, 16.0f, 2000.0, false, 'P',customDate5, 5));
			list.add(new VehicleEntity(6,"Porsche Taycan","Porsche", 1234567895L, 20.0f, 930.0, true, 'E',customDate6, 4));
			list.add(new VehicleEntity(7,"Honda Jazz", "Honda", 1234567896L, 20.0f, 2500.0, false, 'P', customDate7, 5));
